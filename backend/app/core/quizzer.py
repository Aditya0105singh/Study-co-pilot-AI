...
def generate_questions(text: str, previous_context: str = "", answer_style: str = "Beginner Friendly", api_choice: str = "Gemini") -> str:
    """
...
def solve_questions(user_questions: str, previous_context: str = "", word_limit: int = 100, answer_style: str = "Beginner Friendly", api_choice: str = "Gemini") -> str:
    """
...
def evaluate_answers(questions: str, user_answers: str, previous_context: str = "", answer_style: str = "Beginner Friendly", api_choice: str = "Gemini") -> str:
    """
