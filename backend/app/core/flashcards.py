...
from backend.app.core.prompt_templates import SYSTEM_PROMPT, build_final_prompt

def generate_flashcards_api(topic: str, previous_context: str = "", api_choice: str = "Gemini") -> str:
    """
